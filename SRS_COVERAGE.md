...
| FR-3.1 | Custom competency frameworks (admin) | ✅ Done | /admin/competencies + /platform/competency-roles |
| FR-3.2 | Dynamic score verification vs baselines | ✅ Done | POST /platform/gap-analysis |
| FR-3.3 | Machine-readable gap analysis record | ✅ Done | GapAnalysisRecord persisted (scores + gaps JSON) |
...
| FR-9.1 | Base price management | ✅ Done | /admin/pricing panel + PUT /platform/pricing (enterprise + link prices) |
| FR-9.2 | Coupon configuration matrix | ✅ Done | /coupons CRUD + validate |
| FR-9.3 | Promotional banners | ✅ Done | /admin/pricing banner creator + in-app banner strip (ALL/TRIAL audiences) |
...
| CMS↔Questions hookup | questions embed CMS media + case studies | ✅ Done | PATCH /cms/questions/:id + picker in CMS Studio |
