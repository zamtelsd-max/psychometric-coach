        ...
        <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
          ...
          <form onSubmit={submit} className="space-y-4">
            ...
            <button type="submit" disabled={loading}
              className="w-full bg-[#245599] text-white font-bold py-3.5 rounded-xl hover:bg-blue-900 disabled:opacity-50 transition-all mt-2">
              {loading ? 'Creating Account…' : 'Create Account & Start Advertising'}
            </button>
          </form>

          <p className="text-center text-sm text-gray-500 mt-4">
            Already have an account? <Link href="/advertise/login" className="text-[#245599] font-semibold">Sign in</Link>
          </p>
