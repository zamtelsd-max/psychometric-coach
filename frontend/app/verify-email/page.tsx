...
function VerifyInner() {
  ...
  const wrap: React.CSSProperties = { minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20, background: 'linear-gradient(160deg,#16335B 0%,#12233f 100%)' };
  const primaryBtn: React.CSSProperties = { marginTop: 18, background: '#C99A2E', color: '#16335B', fontWeight: 800, border: 'none', padding: '12px 22px', borderRadius: 10, cursor: 'pointer', width: '100%', fontSize: 15 };
  const ghostBtn: React.CSSProperties = { marginTop: 10, background: 'transparent', color: '#16335B', fontWeight: 700, border: '1px solid #16335B', padding: '12px 22px', borderRadius: 10, cursor: 'pointer', width: '100%', fontSize: 15 };
    ...
    <div style={wrap}>
      <div style={box}>
        {state === 'verifying' && (<>
          ...
          <h1 style={{ fontSize: 22, fontWeight: 900, color: '#16335B', margin: '10px 0' }}>Verifying your email…</h1>
        </>)}
        {state === 'ok' && (<>
          <div style={{ fontSize: 54 }}>✅</div>
          <h1 style={{ fontSize: 24, fontWeight: 900, color: '#16335B', margin: '10px 0 8px' }}>Email verified!</h1>
        ...
        {state === 'expired' && (<>
          <div style={{ fontSize: 54 }}>⌛</div>
          <h1 style={{ fontSize: 22, fontWeight: 900, color: '#16335B', margin: '10px 0 8px' }}>Link expired</h1>
        ...
        {state === 'error' && (<>
          ...
          <h1 style={{ fontSize: 22, fontWeight: 900, color: '#16335B', margin: '10px 0 8px' }}>Verification failed</h1>
